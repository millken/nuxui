...
func gendex() error {
	...
	if err := os.MkdirAll(tmpdir+"/work/org/nuxui/app", 0775); err != nil {
		return err
	}
	javaFiles, err := filepath.Glob("../../nux/internal/android/*.java")
	if err != nil {
		return err
	}
	if len(javaFiles) == 0 {
		return errors.New("could not find ../../nux/internal/android/*.java files")
	}
...
var header = `// Copyright 2018 The NuxUI Authors. All rights reserved.
// Use of this source code is governed by a BSD-style
// license that can be found in the LICENSE file.
